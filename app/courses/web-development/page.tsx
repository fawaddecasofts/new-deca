...
const learnItems = [
  { icon: Code2, title: 'HTML5 & CSS3', desc: 'Structure and style modern web pages' },
  { icon: Braces, title: 'JavaScript', desc: 'Add interactivity and dynamic behavior' },
  { icon: Smartphone, title: 'Responsive Layouts', desc: 'Build mobile-friendly websites' },
  { icon: Layers, title: 'WordPress Themes', desc: 'Customize themes and use plugins' },
  { icon: Rocket, title: 'Launch a Website', desc: 'Develop and ship your own WordPress site' },
  { icon: GitBranch, title: 'Git & GitHub', desc: 'Collaborate like a professional developer' },
]

const modules = [
  { num: '01', title: 'HTML5 & CSS3 Foundations', desc: 'Structure and style pages with modern, clean markup.' },
  { num: '02', title: 'JavaScript & Interactive Layouts', desc: 'Bring pages to life with logic and interactivity.' },
  { num: '03', title: 'WordPress Theme Customization', desc: 'Adapt themes and plugins to fit any project.' },
  { num: '04', title: 'WordPress Development & Git/GitHub', desc: 'Build, version, and launch a real website.' },
]

const forWhom = [
  { icon: Sparkles, label: 'Beginners with no prior coding experience' },
  { icon: Briefcase, label: 'Freelancers & designers' },
  { icon: GraduationCap, label: 'Entrepreneurs & content creators' },
  { icon: Globe2, label: 'Future WordPress developers' },
]
...
const tickerMetrics = [
  ...
  'RESPONSIVE SITES BUILT 200+',
  'WORDPRESS THEMES SHIPPED 50+',
  'AVG. PAGE LOAD UNDER 2s',
  'GIT & GITHUB WORKFLOWS COVERED',
  'STUDENT PROJECTS LAUNCHED 300+',
]
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="font-display text-5xl lg:text-6xl font-bold leading-[1.05] mb-6 text-[#13141C]">
            Web
            <br />
            Development<span className="text-[#bf2227]">.</span>
          </h1>

          <p className="text-[#5B5A66] text-base leading-relaxed mb-9 max-w-md">
            Master the essentials of web development and WordPress with our beginner-friendly
            course. Learn HTML, CSS, and JavaScript, then dive into WordPress theme customization
            and development — build and launch real-world projects with confidence.
          </p>
      ...
      <section id="curriculum" className="max-w-7xl mx-auto px-6 py-20">
        <div className="mb-12 max-w-2xl">
          ...
          <h2 className="font-display text-3xl lg:text-4xl font-bold text-[#13141C]">
            Build and launch real websites, from scratch
          </h2>
          <p className="text-[#5B5A66] text-sm leading-relaxed mt-4">
            Kickstart your journey in{' '}
            <strong className="text-[#13141C]">Web Development</strong> with this beginner-friendly
            course — build responsive, modern websites with HTML, CSS, and JavaScript, then dive
            into WordPress theme customization and development.
          </p>
        </div>
