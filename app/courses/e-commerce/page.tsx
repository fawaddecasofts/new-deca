...
//     desc: 'Learn to rank your ecommerce store on Google and drive free organic traffic to your products.',
//     href: '/courses/seo',
...
// const learnItems = [
//   { icon: Store, title: 'Store Setup', desc: 'Launch on Shopify, WooCommerce, or Amazon' },
//   { icon: Package, title: 'Product Sourcing', desc: 'Find and manage profitable products' },
//   { icon: MousePointerClick, title: 'Paid Advertising', desc: 'Run Facebook, Instagram & Google Ads' },
//   { icon: PenTool, title: 'Branding & Design', desc: 'Build a store that converts visitors' },
//   { icon: Truck, title: 'Order Fulfillment', desc: 'Manage shipping, payments & service' },
//   { icon: BarChart3, title: 'Analytics & Growth', desc: 'Track sales and optimize performance' },
// ]

// const modules = [
//   { num: '01', title: 'Store Setup & Platform Selection', desc: 'Choose the right platform and get your store live, fast.' },
//   { num: '02', title: 'Product Research & Supplier Sourcing', desc: 'Find winning products and reliable suppliers to sell with confidence.' },
//   { num: '03', title: 'Branding & Paid Advertising', desc: 'Build a brand people trust, then drive traffic that converts.' },
//   { num: '04', title: 'Order Fulfillment & Customer Retention', desc: 'Deliver a great experience that keeps customers coming back.' },
// ]

// const forWhom = [
//   { icon: Sparkles, label: 'Beginners who want to start an online business' },
//   { icon: Briefcase, label: 'Entrepreneurs taking their business online' },
//   { icon: GraduationCap, label: 'Freelancers wanting to add e-commerce skills' },
//   { icon: Globe2, label: 'Anyone interested in dropshipping or Amazon selling' },
// ]

// const getItems = [
//   { icon: ListChecks, label: 'Step-by-step video tutorials' },
//   { icon: FolderGit2, label: 'Real store setup walkthroughs' },
//   { icon: Award, label: 'Certificate of completion' },
//   { icon: InfinityIcon, label: 'Lifetime access to materials' },
// ]

// const tickerMetrics = [
//   'AVG. CONVERSION RATE +85%',
//   'PAID ADS ROAS 5.2x',
//   'CART RECOVERY +40%',
//   'STORE LAUNCH IN 14 DAYS',
//   'ON-TIME FULFILLMENT 99%',
...
//         <div className="relative">
//           <Image
//             src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=700&q=80"
//             alt="E-Commerce store management"
//             width={580}
//             height={420}
