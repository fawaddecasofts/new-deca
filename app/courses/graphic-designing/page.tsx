...
const learnItems = [
  { icon: Palette, title: 'Color & Typography', desc: 'Master color theory, layout, and composition' },
  { icon: Layers, title: 'Photoshop & Illustrator', desc: 'Mastery of industry-standard design tools' },
  { icon: PenTool, title: 'Logo & Brand Identity', desc: 'Design logos and identities that stand out' },
  { icon: ImageIcon, title: 'Social Media & Print', desc: 'Create posters, brochures, and social content' },
  { icon: LayoutGrid, title: 'UI/UX Fundamentals', desc: 'Intro to modern web and mobile design' },
  { icon: Briefcase, title: 'Portfolio & Freelancing', desc: 'Build a portfolio and land your first clients' },
]

const modules = [
  { num: '01', title: 'Design Foundations & Color Theory', desc: 'Build a strong base in typography, layout, and composition.' },
  { num: '02', title: 'Adobe Photoshop & Illustrator', desc: 'Get hands-on with the tools every designer relies on.' },
  { num: '03', title: 'Logo, Brand & Social Media Design', desc: 'Craft identities and content that capture attention.' },
  { num: '04', title: 'UI/UX Basics & Portfolio Building', desc: 'Step into product design and prep for freelance work.' },
]

const forWhom = [
  { icon: Sparkles, label: 'Aspiring graphic designers' },
  { icon: Briefcase, label: 'Content creators, marketers & entrepreneurs' },
  { icon: GraduationCap, label: 'Students & professionals learning visual design' },
  { icon: Globe2, label: 'Anyone wanting to improve their creative output' },
]

const getItems = [
  { icon: ListChecks, label: 'Hands-on, real-world design projects' },
  { icon: FolderGit2, label: 'Downloadable templates & resources' },
  { icon: Award, label: 'Certificate of completion' },
  { icon: InfinityIcon, label: 'Lifetime access to materials' },
]

const tickerMetrics = [
  '500+ DESIGN PROJECTS DELIVERED',
  'TOOLS PS · AI · ID · XD',
  'CLIENT SATISFACTION 96%',
  'PORTFOLIO PIECES 10+',
  'FREELANCE-READY IN 8 WEEKS',
  'BRAND IDENTITIES CRAFTED 200+',
]
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="font-display text-5xl lg:text-6xl font-bold leading-[1.05] mb-6 text-[#13141C]">
            Graphic
            <br />
            Designing<span className="text-[#bf2227]">.</span>
          </h1>
      ...
      <section id="curriculum" className="max-w-7xl mx-auto px-6 py-20">
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-[#5B5A66] text-sm leading-relaxed mt-4">
            Built around the{' '}
            <strong className="text-[#13141C]">Graphic Designing Course</strong> — a complete
            guide to mastering visual communication, from design fundamentals to industry-standard
            tools and a portfolio-ready skill set.
          </p>
        </div>
