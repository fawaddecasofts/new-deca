...
//     desc: 'Unlock the skills to drive online success with our Digital Marketing Course. Learn how to grow your brand.',
...
//             This course teaches you the fundamentals and advanced strategies of SEO to improve
//             website visibility on search engines like Google. You&apos;ll learn keyword research,
//             on-page and off-page optimization, technical SEO, link-building strategies, and how to
//             use tools like Google Analytics and Search Console. Perfect for marketers, business
//             owners, and content creators, this course helps you drive organic traffic and grow
...
//             {['SEO', 'Keywords', 'Backlinks', 'Analytics'].map((t) => (
...
//       {/* Course Detail — text left, image right */}
//       <section className="max-w-7xl mx-auto px-6 py-12 flex flex-col lg:flex-row gap-14">
//         <div className="flex-1 text-sm leading-relaxed text-gray-700 space-y-6">

//           {/* SEO Optimized badge */}
//           <div className="flex items-center gap-2">
//             <h2 className="text-xl font-extrabold text-gray-900">SEO Optimized Version</h2>
//           </div>

//           <p>
//             This <strong>Course</strong> is ideal for anyone who wants to rank websites on search
//             engines like Google. SEO (Search Engine Optimization) is a powerful digital marketing
//             skill that drives organic (free) traffic to websites. In this course, you will learn
//             beginner to advanced Search Engine Optimization techniques in a simple, step-by-step
//             format. You&apos;ll gain hands-on experience in{' '}
//             <strong>on-page SEO, off-page SEO, keyword research, technical SEO, and backlink
//             building</strong>. You will also learn how to use essential search engine optimization
//             tools like{' '}
//             <strong>Google Search Console, SEMrush, Ahrefs, and Google Analytics</strong> to
//             improve website rankings.
//           </p>

//           <div>
//             <p className="font-bold text-gray-900 mb-2">What You Will Learn</p>
//             <ul className="list-disc pl-5 space-y-1 text-gray-600">
//               <li>Introduction to Search Engine Optimization and how search engines work</li>
//               <li>Keyword research tools and strategy</li>
//               <li>On-page: titles, meta tags, content optimization</li>
//               <li>Off-page: backlinks, social signals, authority building</li>
//               <li>Technical: crawling, indexing, site speed, mobile search engine optimization</li>
//               <li>Local Search Engine Optimization for small businesses</li>
//               <li>Using Search Engine Optimization tools: Search Console, Google Analytics, SEMrush</li>
//               <li>Search Engine Optimization auditing and reporting</li>
//             </ul>
//           </div>

//           <div>
//             <p className="font-bold text-gray-900 mb-2">Who Should Enroll</p>
//             <ul className="list-disc pl-5 space-y-1 text-gray-600">
//               <li>Freelancers and digital marketers</li>
//               <li>Bloggers and content creators</li>
//               <li>Business owners wanting to increase traffic</li>
//               <li>Students pursuing digital marketing careers</li>
//             </ul>
//           </div>
//         </div>
...
const learnItems = [
  { icon: Search, title: 'Keyword Research', desc: 'Find high-value search terms that convert' },
  { icon: FileText, title: 'On-Page SEO', desc: 'Optimize titles, meta tags & content' },
  { icon: Link2, title: 'Off-Page & Backlinks', desc: 'Build authority with quality backlinks' },
  { icon: Gauge, title: 'Technical SEO', desc: 'Improve crawling, indexing & site speed' },
  { icon: MapPin, title: 'Local SEO', desc: 'Rank small businesses in local search' },
  { icon: BarChart3, title: 'Analytics & Reporting', desc: 'Track rankings with GSC & GA tools' },
]

const modules = [
  { num: '01', title: 'SEO Fundamentals & How Search Engines Work', desc: 'Understand the ranking signals that drive organic visibility.' },
  { num: '02', title: 'Keyword Research & On-Page Optimization', desc: 'Find the right terms and optimize every page that matters.' },
  { num: '03', title: 'Off-Page SEO & Link-Building Strategies', desc: 'Earn authority and trust through quality backlinks.' },
  { num: '04', title: 'Technical SEO, Local SEO & Analytics', desc: 'Fix what search engines see, then measure what works.' },
]

const forWhom = [
  { icon: Sparkles, label: 'Freelancers and digital marketers' },
  { icon: Briefcase, label: 'Bloggers and content creators' },
  { icon: GraduationCap, label: 'Business owners wanting to increase traffic' },
  { icon: Globe2, label: 'Students pursuing digital marketing careers' },
]

const getItems = [
  { icon: ListChecks, label: 'Step-by-step tutorials' },
  { icon: FolderGit2, label: 'SEO audit & reporting templates' },
...
const tickerMetrics = [
  ...
  'DOMAIN AUTHORITY +25 PTS',
  'TOOLS GSC · GA4 · SEMRUSH · AHREFS',
  'PAGE SPEED SCORE 90+',
  'BACKLINKS BUILT 1000+',
]
    ...
    <main className="bg-[#FAF8F3] text-[#1A1B23]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="font-display text-5xl lg:text-6xl font-bold leading-[1.05] mb-6 text-[#13141C]">
            SEO<span className="text-[#bf2227]">.</span>
          </h1>

          <p className="text-[#5B5A66] text-base leading-relaxed mb-9 max-w-md">
            This course teaches you the fundamentals and advanced strategies of SEO to improve
            website visibility on search engines like Google. Learn keyword research, on-page and
            off-page optimization, technical SEO, and link-building to drive organic traffic and
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-6 left-6 right-6 bg-[#13141C] rounded-xl px-5 py-4 flex items-center gap-3 shadow-xl flex-wrap">
            {['SEO', 'Keywords', 'Backlinks', 'Analytics'].map((t, i) => (
      ...
      <section id="curriculum" className="max-w-7xl mx-auto px-6 py-20">
        <div className="mb-12 max-w-2xl">
          ...
          <h2 className="font-display text-3xl lg:text-4xl font-bold text-[#13141C]">
            Rank higher and drive free organic traffic
          </h2>
          <p className="text-[#5B5A66] text-sm leading-relaxed mt-4">
            Built around the <strong className="text-[#13141C]">SEO Course</strong> — ideal for
            anyone who wants to rank websites on Google. Learn beginner to advanced techniques in
            a simple, step-by-step format, with hands-on experience using tools like{' '}
            <strong className="text-[#13141C]">
              Google Search Console, SEMrush, Ahrefs, and Google Analytics
            </strong>
            .
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <p className="font-display text-xl lg:text-2xl font-semibold text-center text-[#13141C]">
          Drive organic traffic and grow your online presence, starting today.
        </p>
      </section>
